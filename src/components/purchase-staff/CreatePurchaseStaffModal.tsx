// components/purchase-staff/CreatePurchaseStaffModal.tsx
import { useState, useEffect } from "react";
import { Employee } from "../../types/employee";
import { Warehouse } from "../../types/warehouse";

interface CreatePurchaseStaffModalProps {
  isOpen: boolean;
  employees: Employee[];
  warehouses: Warehouse[];
  onClose: () => void;
  onCreate: (employeeId: number, warehouseId: number) => void;
}

export default function CreatePurchaseStaffModal({
  isOpen,
  employees,
  warehouses,
  onClose,
  onCreate,
}: CreatePurchaseStaffModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!employeeId || !warehouseId) {
      setError("Please select both employee and warehouse");
      return;
    }

    onCreate(Number(employeeId), Number(warehouseId));
  };
