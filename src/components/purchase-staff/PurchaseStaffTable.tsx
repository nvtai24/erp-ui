// components/purchase-staff/PurchaseStaffTable.tsx
import { useState, useEffect } from "react";
import { PurchaseStaff } from "../../types/purchaseStaff";

interface PurchaseStaffTableProps {
  data: PurchaseStaff[];
  isLoading: boolean;
...
export default function PurchaseStaffTable({
  data,
  isLoading,
  onEdit,
  onDelete,
  itemsPerPage = 10,
}: PurchaseStaffTableProps) {
  const [currentPage, setCurrentPage] = useState(1);
  const [displayedData, setDisplayedData] = useState<PurchaseStaff[]>([]);
