...
export default function PurchaseOrders() {
  ...
  const [purchaseOrders, setPurchaseOrders] = useState<ViewPurchaseOrderDto[]>(
    []
  );
  ...
  }, [purchaseOrders, searchTerm, dateFrom, dateTo]);
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div>
          <Input
            type="text"
            placeholder="Search by ID, Supplier Name, or Contact"
            value={searchTerm}
